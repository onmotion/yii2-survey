...
/* @var $searchModel \common\modules\survey\models\search\SurveyStatSearch */
...
<div id="survey-respondents" class="survey-container">
    ...
    echo Html::label('Add respondents', [], ['class' => 'control-label']);
...
JS
    ...
    echo ListView::widget([
        ...
        'itemView' => function ($model, $key, $index, $widget) use ($surveyId) {
            /** @var $model \common\modules\survey\models\SurveyStat */
            $surveyStat = $model;
            ob_start();
            ?>
